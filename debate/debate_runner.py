...
def run_debate_for_topic(topic, debate_scenario=None, debate_question=None, eval_prompt=None):
    ...
    dm = DebateManager(agents, topic, debate_scenario, debate_question, eval_prompt, config["num_rounds"], config["debate_structure"], config["debate_group"], config["use_extended_personas"], config["announce_final_round"])
