...
agent_prompts = {
    "Neutral American": "You are Bob, an American. You are participating in a debate on a political topic with Mike. Update your views on the topic based on Mike's responses.",
...
if __name__ == "__main__":
    ...
    for topic_name, topic_question in debate_topics.items():
        ...
        agent2 = DebateAgent(name="John (Democratic)", model=model, prompt=agent_prompts["democratic"])
