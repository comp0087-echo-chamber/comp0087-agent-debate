...
if __name__ == "__main__":
    ...
    debate_evaluator = DebateEvaluator(model, config["debate_group"], config["debate_structure"], config["num_rounds"], config["num_debates"], scale=config["scale"], evaluate_again=config["evaluate_again"], use_scenarios=config["use_scenarios"])
